  ...
  var LobbyScreen = class extends DOMScreen {
    ...
    init() {
      ...
      this.lobbySettingsDom.addEventListener("input", (e) => {
        e.preventDefault();
        this.lobbySettingsDom.querySelector(".button[name=update-settings]").setAttribute("data-active", "true");
      });
    }
    ...
    <div class="lobby-settings-wrapper">
      <div class="lobby-settings-column">
          <div class="game-setting-entry">
            ...
            <input type="number" name="${"questionCount" /* QUESTION_COUNT */}" autocomplete="off" min=3 max=50 required value="${settings["questionCount" /* QUESTION_COUNT */]}">
          </div>
          ...
          <div class="game-setting-entry">
              ...
              <div class="game-setting-double">
                <input type="number" name="${"minPopularity" /* MIN_POPULARITY */}" autocomplete="off" min=-1 max=10000 required value="${settings["minPopularity" /* MIN_POPULARITY */]}">
              -
                <input type="number" name="${"maxPopularity" /* MAX_POPULARITY */}" autocomplete="off" min=-1 max=10000 required value="${settings["maxPopularity" /* MAX_POPULARITY */]}">
              </div>

              <label class="game-setting-list-option" for="gs_mainOnly">
                  <input type="checkbox" id="gs_mainOnly" name="${"mainRoleOnly" /* MAIN_ROLE_ONLY */}" ${settings["mainRoleOnly" /* MAIN_ROLE_ONLY */] ? "checked" : ""}> Main characters only
              </label>
            </div>
      </div>
      ...
      <div class="lobby-settings-column">
        ...
        return `<label class="game-setting-list-option" for="q_${qId}">
              <input type="checkbox" id="q_${qId}" name="${"activeQuestions" /* ACTIVE_QUESTIONS */}" value="${qId}" ${settings["activeQuestions" /* ACTIVE_QUESTIONS */].some((q) => qId === q) ? "checked" : ""}>
